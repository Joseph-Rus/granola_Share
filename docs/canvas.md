...
| An assignment's folder found by a spec.md naming its `canvas_id` or Canvas URL | **Restored (T1)** for any folder directly under `Canvas/assignments/` | Marginalia also guessed from folder names (`match_existing`); see below. |
